    ...
    <div className="fixed inset-0 z-50 overflow-hidden bg-slate-900/30 backdrop-blur-xs flex justify-end animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="p-5 border-b border-slate-200 bg-white sticky top-0 z-10">
            ...
            <div className="flex items-center gap-2">
              {onViewMemberQR && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-blue-50 hover:bg-blue-100 text-blue-900 border border-blue-300 rounded-lg shadow-sm transition-colors"
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm transition-colors"
              >
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4 pt-3 border-t border-slate-100">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-mono bg-blue-50/80 hover:bg-blue-100 border border-blue-200 rounded text-blue-900 font-semibold transition-colors"
              title="Copy direct deep link URL (?member=ID)"
            >
              {copiedKey === 'deeplink' ? <Check className="w-3 h-3 text-emerald-600" /> : <Copy className="w-3 h-3 text-blue-600" />}
        ...
        <div className="p-6 space-y-6 flex-1 text-xs">
          ...
          <div className="bg-slate-50/70 border border-slate-200 rounded-xl p-4">
            <h3 className="font-bold text-slate-800 uppercase tracking-wider text-[11px] flex items-center gap-2 mb-3">
              <Server className="w-4 h-4 text-blue-600" /> 5. Enterprise Core & PMS Systems
            </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-slate-50/70 border border-slate-200 rounded-xl p-4">
              <h3 className="font-bold text-slate-800 uppercase tracking-wider text-[11px] flex items-center gap-1.5 mb-2.5">
                <Layers className="w-3.5 h-3.5 text-violet-600" /> 6. Creative Suites
              </h3>
            ...
            <div className="bg-slate-50/70 border border-slate-200 rounded-xl p-4">
              <h3 className="font-bold text-slate-800 uppercase tracking-wider text-[11px] flex items-center gap-1.5 mb-2.5">
                <KeyRound className="w-3.5 h-3.5 text-blue-600" /> 7. Key Management
              </h3>
              <div>
                <div className="flex items-center justify-between">
